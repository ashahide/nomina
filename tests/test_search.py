...
from src.nomina.search import search_pypi
...
class TestSearchPypi(unittest.TestCase):
    ...
    def test_check_pypi_package_valid(self, mock_get):
        ...
        status, message, normalized_name = search_pypi.check_pypi_package('requests')
    ...
    def test_check_pypi_package_not_found(self, mock_get):
        ...
        status, message, normalized_name = search_pypi.check_pypi_package('nonexistentpackage')
    ...
    def test_check_pypi_package_invalid_name(self, mock_get):
        status, message, normalized_name = search_pypi.check_pypi_package('invalid....package...name')
        self.assertFalse(status)
    ...
    def test_check_pypi_package_connection_error(self, mock_get):
        ...
        with self.assertRaises(Exception) as context:
            search_pypi.check_pypi_package('requests')
